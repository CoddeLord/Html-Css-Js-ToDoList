...
function removeTodo(id) {
        const todoElement = document.getElementById(id);
        todoElement.style.animation = 'fadeOut 0.4s ease'; // Stil özelliği burada değiştirilmeli
...
function addTodoToList(todo) {
        ...
        li.innerHTML = `
            ...
            <button onclick="toogleComplete(${todo.id})"><i class="fa-solid fa-check"></i></button>
